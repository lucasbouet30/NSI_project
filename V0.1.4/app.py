...
if RESET == True:
    ...
    con = get_db_connection()
    cur = con.cursor()
    cur.execute('DELETE FROM Users WHERE EXISTS (SELECT 1 FROM Users);')
    password_t = hash_it("testtest123.")
    cur.execute(f'INSERT INTO Users(Id, Email, Password, Pp, Banner, Xp, DiscordId) VALUES (1, "test@gmail.com", "{password_t}", "assets/images/upload/pfps/empty-pfp.svg", "assets/images/upload/banners/empty-banner.svg", 100, 600288096046678036)')
    con.commit()
    con.close()
    # end
